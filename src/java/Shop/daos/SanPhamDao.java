...
public class SanPhamDao {
    ...
    public void themSP(SanPham sp){
          String sql = "INSERT INTO sanpham( Ten, Gia, SanPhamCode, SanPhamDescription,TheLoaiId) VALUES (?, ?, ?,?,?)";
          ...
          try{
             ...
             statement.setInt(5, sp.getTheLoaiId());
    ...
    public void capNhapSP(SanPham sp){
        String sql = "UPDATE sanpham SET TenSanPham = ?, Gia = ?, SanPhamCode = ?,SanPhamDescription = ?,theLoaiId= ?  WHERE SanPhamID = ?";
          Connection conn = ConnectMysql.getConnection();
          PreparedStatement statement =null;
          try{
             statement = conn.prepareStatement(sql);
         ...
         if (conn!=null){
             try {
                 ...
                 while(rsSet.next()){
                     ...
                     sp.setTheLoaiId(rsSet.getInt("TheLoaiId"));
                     rs.add(sp);
                 }
